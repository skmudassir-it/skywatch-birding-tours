...
export const metadata: Metadata = {
  ...
  description:
    "Guided birding walks, dawn chorus tours, migratory bird tours, photography-focused birding, private tours, workshops and multi-day birding excursions with SkyWatch Birding Tours.",
};
      ...
      <section className="px-4 pb-8 pt-36 sm:pt-40">
        <div className="mx-auto max-w-6xl">
          <SectionHeading
            ...
            title="Seven ways to meet the birds"
            subtitle="Every tour is led by a master guide, capped at ten guests, and stocked with premium optics. Pick your adventure below."
          />
        </div>
      </section>
      ...
      <section className="px-4 py-10 sm:py-14">
        <div className="mx-auto max-w-6xl">
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <span className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-accent">
                      Tour details <ArrowRight className="size-4 transition-transform group-hover:translate-x-1" />
                    </span>
                  </div>
                </Link>
              </StaggerItem>
          ...
          <Reveal className="mt-14 text-center">
            <p className="text-muted-foreground">Not sure which tour fits?</p>
            <Link
              href="/contact"
              className={cn(buttonVariants({ size: "lg" }), "btn-gradient mt-4 rounded-full")}
            >
              Talk to a birding guide <ArrowRight className="size-4" />
            </Link>
          </Reveal>
        </div>
      </section>
