...
export function CtaBand({
  title = "Ready to see the sky like never before?",
  subtitle = "Book a guided walk, workshop or expedition — our guides respond within one business day, and migration weekends go fast.",
      ...
      <Reveal className="mx-auto max-w-6xl">
        <div className="glass-card relative overflow-hidden rounded-3xl">
          <div className="absolute inset-0 -z-10">
            <Image
              src={image}
              alt="Birds in flight over misty wetlands at dawn"
              fill
              sizes="100vw"
          ...
          <div className="relative flex flex-col items-start gap-6 px-6 py-12 sm:px-12 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-xl">
              <p className="text-xs font-bold uppercase tracking-[0.28em] text-accent">Book now</p>
